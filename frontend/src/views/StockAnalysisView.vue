<template>
  <div class="stock-page">
    ...
    <el-dialog v-model="stockDetailDialogVisible" width="60%" :show-close="false" @close="handleStockDetailClose">
      <template #header>
...
import { analyzeStock, fetchHistory, toExtractedJson } from '../api/stockAnalysis';
import type {
  ExtractedJson,
